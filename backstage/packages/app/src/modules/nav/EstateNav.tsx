// Five doors and nothing else (crew#459 redesign, 2026-08-29). The vendor sidebar carried a
...
export const EstateNav = NavContentBlueprint.make({
  params: {
    component: ({ navItems }) => {
      // Every plugin's nav item is taken so nothing renders twice; the five above are the nav.
