...
TERMINATION_KEYS: dict[str, tuple[Any, type, str, str]] = {
    ...
    "time.seconds_per_minute": (
        ...
        int,
        None,
        "Seconds in a minute -- a literal nowhere but a config table (cp22)",
    ),
    "time.minutes_per_hour": (60, int, None, "Minutes in an hour"),
    "trace.signature_field": (
        "trace_sig",
        str,
        "SB_TRACE_SIGNATURE_FIELD",
