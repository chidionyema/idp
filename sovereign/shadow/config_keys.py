...
SHADOW_KEYS: dict[str, tuple[Any, type, str, str]] = {
    ...
    "shadow.refill_boundary_kind": (
        "budget_refill",
        str,
        "SB_SHADOW_REFILL_BOUNDARY_KIND",
    ...
    "shadow.receipt_line_format": (
        "[✓] SHADOW_AUTH | boundary:{boundary} | confidence:{confidence:.2f} | founder_notified:false",
        str,
