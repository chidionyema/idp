...
PRESENCE_KEYS: dict[str, tuple[Any, type, str, str]] = {
    ...
    "presence.ghost_line_template": (
        ...
        str,
        "SB_PRESENCE_GHOST_LINE_TEMPLATE",
    ...
    "presence.emergency_line_template": (
        ...
        str,
        "SB_PRESENCE_EMERGENCY_LINE_TEMPLATE",
