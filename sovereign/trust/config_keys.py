...
TRUST_KEYS: dict[str, tuple[Any, type, str, str]] = {
    ...
    "trust.attestation_fallback_label": (
        "fallback",
        str,
        "SB_TRUST_ATTESTATION_FALLBACK_LABEL",
