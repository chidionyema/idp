...
KEYS: dict[str, KeySpec] = {
    ...
    "model.consensus": KeySpec(["ollama", "deepseek", "minimax"], "list", "SB_MODEL_CONSENSUS", "comma-separated aliases; three different models (spec 4.2): one local, two hosted, because a second local voter on a 16 GB laptop misses the 30 s deadline (measured 2026-08-26: 3-4B models 60-75 s per answer)"),
