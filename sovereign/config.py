...
KEYS: dict[str, KeySpec] = {
    ...
    "temporal.host": KeySpec("temporal-frontend-mesh", "str", "TEMPORAL_HOST", "Temporal frontend host (OKE mesh Service; the tailnet-qualified name is set via TEMPORAL_HOST/TEMPORAL_ADDRESS by the operator, not hardcoded)"),
    ...
    "model.default": KeySpec("minimax", "str", "SB_MODEL", "LiteLLM alias for the llm runner; the twin of `[routing] default` in AGENTS.md (moved off the dead deepseek account 2026-09-08)"),
