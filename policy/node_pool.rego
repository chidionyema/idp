...
# Absent burst or spot rows read as USD 0, so the spot rule below still adds up (a sum with
# an undefined term is undefined in rego, and an undefined deny is a silent pass).
default burst_monthly_usd := 0
