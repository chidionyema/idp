...
| Paid capacity is auto-defaulted up to estate-defaults.yaml monthly_cap_usd and refused above it (crew#281, R14) | policy_gate | policy/fixtures/capacity-over-cap.json | policy/fixtures/capacity-under-cap.json |
