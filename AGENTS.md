...
Verbatim in `~/AGENTS.md`, loaded every session regardless of project — not repeated here
so it is not billed twice per turn. (Removed as a duplicate 2026-09-14; same text, same rule.)
