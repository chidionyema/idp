---
experiment: 20260909T2048Z-ci-flake-triage
...
usd: 0.1603
budget_usd: 1.0
trace: 4f7ed10f-7148-4ba7-b170-3a8fa3382082
artifact: null
forge_commit: c693b6660f8afeb8f3a8832e0721a3ea1fc8f9ea
run_url: https://github.com/chidionyema/idp/actions/runs/34401515600
---
...
| max_steps | -1 |
| GPU | T4 |
| train wall time (s) | 978 |
| cost (USD) | 0.1603 |
| budget (USD) | 1.0 |
| forge commit | c693b6660f8afeb8f3a8832e0721a3ea1fc8f9ea |
| task file | forge/tasks/ci-flake-triage.yaml |
| CI run | https://github.com/chidionyema/idp/actions/runs/34401515600 |
...
|---|---|
| held-out rows | 160 |
| agreement (answered rows) | 0.9772727272727273 |
| abstain rate | 0.175 |
...
| field | value |
|---|---|
| Langfuse trace | https://langfuse.mumchimp.com/trace/4f7ed10f-7148-4ba7-b170-3a8fa3382082 |
| artifact (GHCR) |  |
...
gh workflow run forge-train.yml -f task_file=forge/tasks/ci-flake-triage.yaml -f dry_run=false -f max_steps=-1
# 3. this record
