...
def test_fresh_externalsecrets_leave_the_receipt_ok():
    head = "ok cluster-state at 2026-08-27T05:00:00Z nodes=1 ready=1 pods=45 pods_not_ready=0 flux=21 flux_not_ready=0 ds=3 ds_short=0 deploy_short=0 events_warning=0 monitoring_rules=1 alert_watchdog=1 cpu_used_pct=12 cpu_req_pct=45 mem_used_pct=30 mem_req_pct=50"
