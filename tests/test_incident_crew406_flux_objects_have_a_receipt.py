...
def _receipt(flux_not_ready: list, with_count: bool = True) -> str:
    ...
    if with_count:
        head += f" flux=20 flux_not_ready={n} ds=3 ds_short=0 deploy_short=0 events_warning=0 monitoring_rules=1 alert_watchdog=1 cpu_used_pct=30 mem_used_pct=25 cpu_req_pct=12 mem_req_pct=4"  # crew#320, crew#539, crew#584 rows
