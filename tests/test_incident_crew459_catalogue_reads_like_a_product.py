...
ROWS = [
    {
        ...
        "id": "ai.aiden.watch",
        "root": "x",
        "path": "/Users/someone/work/x/watch.py",
        "what": "One tick of Aiden.",
        "loaded": True,
        "last_status": "clean",
        "interval_s": 60,
    },
    ...
    },
    {
        ...
        "id": "receipts",
        "root": "x",
        "path": "/Users/other/.estate/receipts.jsonl",
        "rows": 3,
    },
]
...
def test_incident_no_home_directory_no_label_titles_no_vendor_software(tmp_path):
    ...
    assert "/Users/" not in text and "/home/" not in text, [
        l for l in text.splitlines() if "/Users/" in l or "/home/" in l
    ][:3]
...
def test_the_other_way_a_plain_id_keeps_its_title_and_an_estate_job_is_still_written(
    tmp_path,
):
    text, by = _generate(
        tmp_path,
        [
            {
                ...
                "id": "nightly-backup",
                "root": "x",
                "path": "/opt/estate/backup.sh",
                "what": "Copies the ledgers offsite every night.",
                "loaded": True,
                "last_status": "clean",
            }
        ],
