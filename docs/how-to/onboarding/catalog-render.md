...
What it is: the scheduled job that keeps `docs/explanation/architecture/live.md` current on main. It is
...
render waiting on checks; `git log -- docs/explanation/architecture/live.md` on main shows every render
