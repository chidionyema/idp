...
docs/tutorials/demo/security-policy.md              a working run in that control's context
docs/how-to/onboarding/security-policy.md        the wider security-policy control set
```
