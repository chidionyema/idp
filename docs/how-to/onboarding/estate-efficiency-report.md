# Onboarding: estate efficiency report
...
`estate-efficiency-report` exists to estate efficiency report. Run it from the repo root on any machine
...
```
bin/estate-efficiency-report --help
```
