# Onboarding: estate efficiency experiment
...
`estate-efficiency-experiment` exists to estate efficiency experiment. Run it from the repo root on any machine
...
```
bin/estate-efficiency-experiment --help
```
