...
docs/tutorials/demo/kini.md                   what is live, with captured output
```
...
```
docs/how-to/onboarding/litellm.md          the router itself
docs/how-to/onboarding/langfuse.md         where the traces land
