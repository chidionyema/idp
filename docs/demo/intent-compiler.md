# Demo: the deterministic estate compiler (Diamond Standard, crew#804)

What the founder sees when it runs, measured 2026-09-01 on this branch.
...
filesystem, two replicas spread across nodes), a Service and an HTTPRoute at
