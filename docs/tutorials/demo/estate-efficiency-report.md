# estate efficiency report -- a demo

This page demonstrates `estate-efficiency-report` running against the live fleet. It is the
...
```
bin/estate-efficiency-report --self-test
```
