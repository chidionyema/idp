...
```
FAIL  law32 docs/tutorials/demo/idp.md: not in mkdocs.yml nav, so the portal never shows it
FAIL  law32 docs/tutorials/demo/mcp.md: not in mkdocs.yml nav, so the portal never shows it
FAIL  law32 docs/tutorials/demo/placement.md: not in mkdocs.yml nav, so the portal never shows it
```
