...
(A.5.21, supply-chain integrity); see `docs/tutorials/demo/security-policy.md` for it in
that context and `docs/how-to/onboarding/security-policy.md` for how to turn the
control off.
