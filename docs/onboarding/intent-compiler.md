# Onboarding: the deterministic estate compiler (Diamond Standard, crew#804)
...
never notice. Founder order 2026-09-01 ("Execute the Diamond Standard"); decision record:
