...
claude-estate docs/founder/, branch founder-docs-visual-demos). Build word: his "ok" on the
crew#805 plan, 2026-09-01. Research record with all sources:
...
2. **One surface.** The feature's `docs/demo/<name>.md` page embeds the rendered file and states
   the command a buyer can run himself; Backstage TechDocs serves it; R66 pins the release.
3. **The buyer clicks the real thing.** A 60-minute expiring vCluster sandbox (CP5, next wave) —
