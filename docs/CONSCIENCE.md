...
**🧠 4/7 tenets green — red: future-looking, research.** moved +0 since the last reading.

Measured 2026-09-15T12:45:21+00:00 on `runnervmlun5p`. The score is read from the receipt, never from a file scan (LAW 50). A red row has one open issue labelled `conscience`; a tenet nobody can measure is BLIND, and BLIND is never green.
