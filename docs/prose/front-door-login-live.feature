# Prose until a drill runs them: these probe the live front door through the login row of bin/idp-verify (ADR 0007).
Feature: The live front door redirects to the identity domain and holds no password
