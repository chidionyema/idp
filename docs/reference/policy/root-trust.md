...
| `bitwarden-machine` | platform/human-vault/access-token.yaml | Bitwarden (machine account) | the access token is born once in the founder's browser (Bitwarden web vault, decision 0017) and placed in the OCI vault by his browser; the runbook quoting the vendor's own console steps is docs/how-to/bitwarden-human-vault.md | MISS | [the bridge ticket](https://github.com/chidionyema/crew/issues/809) |
